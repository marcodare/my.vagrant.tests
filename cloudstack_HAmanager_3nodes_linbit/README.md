...
linstor. Due reti: fake public host-only 192.168.61.0/24 e privata internal
10.61.0.0/24. La NIC NAT tecnica di Vagrant resta separata. Solo questo lab acceso.
...
| --- | --- | --- | --- | --- | --- |
| mgmt1/2/3 | 192.168.61.11/.12/.13 | 10.61.0.11/.12/.13 | 8 GiB | 4 | OS 80 |
| kvm1/2/3 | 192.168.61.21/.22/.23 | 10.61.0.21/.22/.23 | 20 GiB | 6 | OS 80 + dati 200 |
...
HAProxy/Keepalived, agent KVM e pacchetti linstor. Nessun disco dati viene
...
secondario NFS **10.61.0.7**. Nel lab LINSTOR, controller VIP **10.61.0.6**.
Non assegnare questi IP a guest manuali. UI finale: **http://192.168.61.5/client/**.
